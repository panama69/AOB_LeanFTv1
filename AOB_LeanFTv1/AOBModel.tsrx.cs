...
namespace AOB_LeanFTv1
{
	...
	public class AOBModel : AppModelBase
	{
		#region Constructors

		public AOBModel(ITestObject contextTestObject)
		{
			Name = @"AOBModel";
		...
		public sealed class AdvantageOnlineBankingPageNode : PageNodeBase
		{
			...
			public AdvantageOnlineBankingPageNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
			{
				...
				UserPassword = new UserPasswordNode(this, applicationModel);
				LogoutLink = new LogoutLinkNode(this, applicationModel);
				LoginButton = new LoginButtonNode(this, applicationModel);
				AccountsLink = new AccountsLinkNode(this, applicationModel);
				MoneyTransferLink = new MoneyTransferLinkNode(this, applicationModel);
				FromAccountListBox = new FromAccountListBoxNode(this, applicationModel);
				ToAccountListBox = new ToAccountListBoxNode(this, applicationModel);
				NextButton = new NextButtonNode(this, applicationModel);
				AmountEditField = new AmountEditFieldNode(this, applicationModel);
				TransferDateEditField = new TransferDateEditFieldNode(this, applicationModel);
				ReferenceNumber = new ReferenceNumberNode(this, applicationModel);
				OKButton = new OKButtonNode(this, applicationModel);
				Amount100WebElement = new Amount100WebElementNode(this, applicationModel);
			...
			public UserPasswordNode UserPassword { get; private set; }
			public LogoutLinkNode LogoutLink { get; private set; }
			public LoginButtonNode LoginButton { get; private set; }
			public AccountsLinkNode AccountsLink { get; private set; }
			public MoneyTransferLinkNode MoneyTransferLink { get; private set; }
			public FromAccountListBoxNode FromAccountListBox { get; private set; }
			public ToAccountListBoxNode ToAccountListBox { get; private set; }
			public NextButtonNode NextButton { get; private set; }
			public AmountEditFieldNode AmountEditField { get; private set; }
			public TransferDateEditFieldNode TransferDateEditField { get; private set; }
			public ReferenceNumberNode ReferenceNumber { get; private set; }
			public OKButtonNode OKButton { get; private set; }
			public Amount100WebElementNode Amount100WebElement { get; private set; }
			...
			public sealed class UserPasswordNode : EditFieldNodeBase
			{
				#region Constructors
			
				public UserPasswordNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
					DisplayName = @"j_password";
				}
			...
			public sealed class LogoutLinkNode : LinkNodeBase
			{
				#region Constructors
			
				public LogoutLinkNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
					DisplayName = @"Logout";
				}
			...
			public sealed class AccountsLinkNode : LinkNodeBase
			{
				#region Constructors
			
				public AccountsLinkNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class MoneyTransferLinkNode : LinkNodeBase
			{
				#region Constructors
			
				public MoneyTransferLinkNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class FromAccountListBoxNode : ListBoxNodeBase
			{
				#region Constructors
			
				public FromAccountListBoxNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class ToAccountListBoxNode : ListBoxNodeBase
			{
				#region Constructors
			
				public ToAccountListBoxNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class AmountEditFieldNode : EditFieldNodeBase
			{
				#region Constructors
			
				public AmountEditFieldNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
					DisplayName = @"amount";
				}
			...
			public sealed class TransferDateEditFieldNode : EditFieldNodeBase
			{
				#region Constructors
			
				public TransferDateEditFieldNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class ReferenceNumberNode : WebElementNodeBase
			{
				#region Constructors
			
				public ReferenceNumberNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
				...
				protected override HP.LFT.SDK.Web.WebElementDescription CreateDescription()
				{
					...
					{
						TagName = @"DIV",
						InnerText = As.RegExp(@"Reference Number: #........-....-....-....-............")
					};
				}
			...
			public sealed class Amount100WebElementNode : WebElementNodeBase
			{
				#region Constructors
			
				public Amount100WebElementNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
					DisplayName = @"Amount: $1.00";
				}
